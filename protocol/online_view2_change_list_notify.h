...
namespace protocol {
    ...
    public:
        ...
        const linkerProtocol::OnlineView2ChangeListNotify &
        get_online_view2_change_list_notify() const { return this->o; }
        ...
        virtual void from_json(jsonxx::Object &o) {
            if (o.has<jsonxx::Array>("changeList")) {
                ...
                for (size_t i = 0; i < os.size(); i++) {
                    ...
                    k.get_online_view2_change_notify().SerializeToArray(buf,
                                                                        k.get_online_view2_change_notify().ByteSize());
