...
#ifndef DANMU_CORE_ROOM_LOT_GIFT_ATTR_H
#define DANMU_CORE_ROOM_LOT_GIFT_ATTR_H

#include "protobuf.h"

namespace protocol {
    class RoomLotGiftAttr : public Protocol {
    public:
        RoomLotGiftAttr() : r(linkerProtocol::RoomLotGiftAttr()) {};
        explicit RoomLotGiftAttr(const linkerProtocol::RoomLotGiftAttr &us) : r(us) {};
...
#endif //DANMU_CORE_ROOM_LOT_GIFT_ATTR_H