...
namespace protocol {
    class UserLevelUpNotify : public Protocol {
    public:
        UserLevelUpNotify() : u(linkerProtocol::UserLevelUpNotify()) {};
        explicit UserLevelUpNotify(const linkerProtocol::UserLevelUpNotify &us) : u(us) {};
