        ...
        virtual void from_json(jsonxx::Object &o) {
            ...
            if (o.has<jsonxx::Array>("drawList")) {
                ...
                for (size_t i = 0; i < ds.size(); i++) {
                    ...
                    k.get_double_eleven_lottery_draw_list().SerializeToArray(buf,
                                                                             k.get_double_eleven_lottery_draw_list().ByteSize());
            ...
            if (o.has<jsonxx::Array>("prizeList")) {
                ...
                for (size_t i = 0; i < ds.size(); i++) {
                    ...
                    k.get_double_eleven_lottery_prize_list().SerializeToArray(buf,
                                                                              k.get_double_eleven_lottery_prize_list().ByteSize());
            ...
            if (o.has<jsonxx::Array>("bestAssistList")) {
                ...
                for (size_t i = 0; i < ds.size(); i++) {
                    ...
                    k.get_double_eleven_lottery_best_assist_list().SerializeToArray(buf,
                                                                                    k.get_double_eleven_lottery_best_assist_list().ByteSize());
