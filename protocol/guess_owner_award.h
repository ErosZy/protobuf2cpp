...
namespace protocol {
    class Guess_owner_award : public Protocol {
    public:
        Guess_owner_award() : g(linkerProtocol::GuessOwnerAward()) {};

        explicit Guess_owner_award(const linkerProtocol::GuessOwnerAward &us) : g(us) {};
